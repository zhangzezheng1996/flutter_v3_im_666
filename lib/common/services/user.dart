...
class UserService extends GetxService {
  ...
  /// username
  // String get username => _profile.value.username ?? "";

  /// id
  String get id => _profile.value.id ?? "";

  /// im sign
  String get imSign => _profile.value.imSign ?? "";
  ...
  Future<void> logout() async {
    ...
    //移除聊天记录
    await Storage().remove(Constants.storageChatConversations);
